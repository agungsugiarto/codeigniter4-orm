...
use Fluent\Orm\InvalidCastException;
use Fluent\Orm\JsonEncodingException;
...
trait HasAttributes
{
    ...
    {
        return (static::$encrypter ?? Services::encrypter())->decrypt($value, false);
    }
    ...
    {
        return (static::$encrypter ?? Services::encrypter())->encrypt($value, false);
    }
    ...
    protected function asDateTime($value)
    {
        ...
        if ($this->isStandardDateFormat($value)) {
            return Time::instance(Carbon::createFromFormat('Y-m-d', $value)->startOfDay());
        }
     ...
     * @return bool
     *
     * @throws \Fluent\Orm\InvalidCastException
     */
