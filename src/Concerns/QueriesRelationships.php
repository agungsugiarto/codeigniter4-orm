...
trait QueriesRelationships
{
     ...
     *
     * @param  \Fluent\Orm\Relations\Relation|string  $relation
     ...
     *
     * @param  \Fluent\Orm\Relations\MorphTo|string  $relation
     ...
     *
     * @param  \Fluent\Orm\Relations\MorphTo  $relation
     * @param  string  $type
     ...
     *
     * @param  \Fluent\Orm\Builder  $hasQuery
     * @param  \Fluent\Orm\Relations\Relation  $relation
     * @param  string  $operator
     * @param  int  $count
     * @param  string  $boolean
     * @return \Fluent\Orm\Builder|static
