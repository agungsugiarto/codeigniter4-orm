...
class Model implements Arrayable, ArrayAccess, Jsonable, JsonSerializable
{
     ...
     * @return $this
     *
     * @throws \Fluent\Orm\Exceptions\MassAssignmentException
     */
     ...
     *
     * @param  \Tightenco\Collect\Support\Collection|array|int|string  $ids
     * @return int
     */
     ...
     *
     * @return \Fluent\Orm\Builder|static
     */
     ...
     * @return string
     *
     * @throws \Fluent\Orm\JsonEncodingException
     */
     ...
     *
     * @param  \Fluent\Orm\Model|null  $model
     * @return bool
     */
     ...
     *
     * @param  \CodeIgniter\Database\ConnectionInterface  $resolver
     * @return void
     */
    public static function setConnectionResolver(ConnectionInterface $resolver)
    {
