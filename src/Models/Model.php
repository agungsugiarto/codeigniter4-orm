...
class Model extends BaseModel implements \JsonSerializable
{
    ...
    /**
     * Attributes to Fluentend to a model.
     *
     * @var array
     */
    protected $Fluentends = [];
    ...
    /**
     * Fluently global scopes.
     *
     * @return $this
     */
    public function FluentlyScopes()
    {
        if (! $this->scopes) {
            return $this;
        }
    ...
    /**
     * Fluently the given scope on the current builder instance.
     *
