...
abstract class AbstractCursorPaginator implements Htmlable
{
     ...
     * The current cursor.
     *
     * @var \Fluent\Orm\Pagination\Cursor|null
     */
    protected $cursor;
     ...
     *
     * @param  \Fluent\Orm\Pagination\Cursor|null  $cursor
     * @return string
     */
     ...
     *
     * @return \Fluent\Orm\Pagination\Cursor|null
     */
     ...
     * @param  bool  $isNext
     * @return \Fluent\Orm\Pagination\Cursor
     */
