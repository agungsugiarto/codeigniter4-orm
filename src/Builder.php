...
class Builder
{
     ...
     * @param  \Fluent\Orm\Contracts\Scope|\Closure  $scope
     * @return $this
     */
     ...
     *
     * @param  \Fluent\Orm\Contracts\Scope|string  $scope
     * @return $this
     */
     ...
     * @param  mixed  $id
     * @param  array  $columns
     * @return \Fluent\Orm\Model|\Fluent\Orm\Collection|static[]|static|null
     */
     ...
     * @param  mixed  $id
     * @param  array  $columns
     * @return \Fluent\Orm\Model|\Fluent\Orm\Collection|static|static[]
     *
     ...
     * @return \Fluent\Orm\Model|static|mixed
     */
     ...
     *
     * @throws \Fluent\Orm\ModelNotFoundException
     * @throws \Fluent\Orm\Exceptions\MultipleRecordsFoundException
     */
     ...
     *
     * @param  string  $name
     * @return \Fluent\Orm\Relations\Relation
     */
    ...
    {
        $whereGroup = $this->getQuery()->resetQuery()->from($this->model->getTable());
