...
use Fluent\Orm\Relations\MorphPivot;
use Fluent\Orm\Relations\Pivot;
use Fluent\Orm\Relations\Relation;
use Fluent\Orm\SoftDeletes;
use Fluent\Orm\SoftDeletingScope;
use CodeIgniter\Database\Exceptions\DatabaseException;
use CodeIgniter\Test\CIUnitTestCase;
use CodeIgniter\Test\ReflectionHelper;
use Fluent\Orm\Pagination\AbstractPaginator as Paginator;
    ...
    protected function createSchema()
    {
        ...
        foreach (['tests', 'default'] as $connection) {
            $this->schema($connection)->addField([
                ...
                'birthday' => ['type' => 'timestamp', 'null' => true],
                'created_at' => ['type' => 'datetime', 'null' => true],
                'updated_at' => ['type' => 'datetime', 'null' => true],
            ])
            ->addPrimaryKey('id')
            ...
            $this->schema($connection)->addField([
                ...
                'friend_id' => ['type' => 'int', 'constraint' => 255],
                'friend_level_id' => ['type' => 'int', 'constraint' => 11, 'unsigned' => true, 'null' => true],
            ])
            ...
            ->addPrimaryKey('id')
            ->createTable('friend_levels', true);
            ...
            ->addPrimaryKey('id')
            ->createTable('soft_deleted_users', true);
            ...
            ->addPrimaryKey('id')
            ->createTable('tags', true);

            $this->schema($connection)->addField([
                'tag_id' => ['type' => 'int', 'constraint' => 11, 'unsigned' => true],
                'taggable_type' => ['type' => 'varchar', 'constraint' => 255],
                'taggable_id' => ['type' => 'int', 'constraint' => 11, 'unsigned' => true],
                'taxonomy' => ['type' => 'varchar', 'constraint' => 255, 'null' => true],
                'created_at' => ['type' => 'datetime', 'null' => true],
                'updated_at' => ['type' => 'datetime', 'null' => true],
            ])
            ->createTable('taggables', true);
        }

        $this->schema($connection)->addField([
            'name' => ['type' => 'varchar', 'constraint' => 255, 'null' => true],
        ])
        ->createTable('non_incrementing_users', true);
    }
