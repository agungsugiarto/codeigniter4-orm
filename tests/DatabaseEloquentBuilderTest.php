...
class DatabaseEloquentBuilderTest extends TestCase
{
    ...
    {
        $builder = m::mock(Builder::class.'[get,limit]', [$this->getMockQueryBuilder()]);
    ...
    public function testChunkWithLastChunkComplete()
    {
        ...
        $builder->getQuery()->QBOrderBy[] = ['column' => 'foobar', 'direction' => 'asc'];
    ...
    public function testMissingStaticMacrosThrowsProperException()
    {
        ...
        $this->expectExceptionMessage('Call to undefined method Fluent\Orm\Builder::missingMacro()');
    ...
    //     $this->mockConnectionForModel($model, 'tests');
    ...
    //     $this->assertEquals(['bar', 9000], $query->getBinds());
    // }
    ...
    protected function mockConnectionForModel($model, $database)
    {
        ...
        $class::setConnectionResolver(db_connect($database));
    }
